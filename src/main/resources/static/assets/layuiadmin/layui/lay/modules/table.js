    ...
    F.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), t.ajax({
                type: a.method || "get",
                url: a.url,
                contentType: a.contentType ? a.contentType : 'application/json',
                data: d,
                dataType: "json",
                headers: a.headers || {},
                success: function (t) {
                ...
                error: function (e, t) {
                    if(e.status === 401) {
                        ...
                        i.layMain.html('<div class="' + f + '">数据接口请求异常：' + e.responseJSON.msg + "(" + e.responseJSON.code + ")</div>"), i.renderForm(), i.setColsWidth()
                    } else {
