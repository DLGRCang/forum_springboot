package com.cm.forum.controller.resource.forumrelease;
...
/**
 * @ClassName: ForumReleaseResourceController
 * @Description: 
 * @Author: CodeFactory
...
@RestController
@RequestMapping(ISystemConstant.RESOURCE_PREFIX + "/forum-release")
public class ForumReleaseResourceController extends DefaultBaseController {
