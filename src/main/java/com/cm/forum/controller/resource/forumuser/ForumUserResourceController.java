package com.cm.forum.controller.resource.forumuser;
...
/**
 * @ClassName: ForumUserResourceController
 * @Description: 
 * @Author: CodeFactory
...
@RestController
@RequestMapping(ISystemConstant.RESOURCE_PREFIX + "/forum-user")
public class ForumUserResourceController extends DefaultBaseController {
